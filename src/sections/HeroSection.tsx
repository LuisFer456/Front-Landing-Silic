...
export function HeroSection() {
  return (
    <section id="hero" className="border-b border-white/10 py-14 sm:py-18 md:py-24 lg:py-28">
      <Container className="grid gap-8 sm:gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
        <motion.div
        ...
        >
          <p className="text-[11px] uppercase tracking-[0.18em] text-zinc-500 sm:text-xs sm:tracking-[0.2em]">Lujo contemporaneo · Edicion limitada · Hecho para destacar</p>
          <h1 className="font-serif text-[2.35rem] leading-[0.98] text-zinc-50 sm:text-6xl md:text-7xl">
            SILIC, sneakers premium para quienes compran presencia.
          </h1>
          <p className="max-w-xl text-[15px] leading-7 text-zinc-300 md:text-lg">
